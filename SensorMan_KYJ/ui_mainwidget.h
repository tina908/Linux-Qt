...
public:
    ...
    void retranslateUi(QWidget *MainWidget)
    {
        ...
        pTabWidget->setTabText(pTabWidget->indexOf(pTab2), QCoreApplication::translate("MainWidget", "Socket", nullptr));
        pTabWidget->setTabText(pTabWidget->indexOf(pTab4), QCoreApplication::translate("MainWidget", "Sensor", nullptr));
        pTabWidget->setTabText(pTabWidget->indexOf(pTab5), QCoreApplication::translate("MainWidget", "Sqlite", nullptr));
    } // retranslateUi
